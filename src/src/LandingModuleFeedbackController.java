public class LandingModuleFeedbackController {
	...
	private final double sideForce = 1000; //Force generated by side thrusters ((kg*m)/s^2)
	...
	/** Constructs a landing module with the same parameters as the other constructor,
	  * only the angle is not given
	  */
