...
public class LandingModuleFeedbackControllerWithParachute implements LandingModule {
	...
	private static double mainForce = 2500; // Force generated by main thruster ()(kg*m)/s^2)
	...
	private static double MAXWINDFORCE = 2;
     ...
     */
    public LandingModuleFeedbackControllerWithParachute (double weight, Vector2D position, Vector2D velocity, double angle, boolean addWind) {
        this.weight = weight;
    ...
    /** Constructs a landing module with one less parameter than the full constructor
	  ...
	  * @param angle the angle of the module with respect to the y-axis
      */
	public LandingModuleFeedbackControllerWithParachute (double weight, Vector2D position, Vector2D velocity, double angle) {
    ...
    /** Constructs a landing module with one less parameter than the full constructor
      ...
      * @param velocity velocity of module
 	  * @param addWind whether we add randomized wind to the simulation or not
      */
    public LandingModuleFeedbackControllerWithParachute (double weight, Vector2D position, Vector2D velocity, boolean addWind) {
	...
	/** Constructs a landing module with two less parameters than the full constructor
      ...
      * @param velocity velocity of module
      */
    public LandingModuleFeedbackControllerWithParachute (double weight, Vector2D position, Vector2D velocity) {
